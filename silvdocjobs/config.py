...
SOURCES: list[SourceConfig] = [
    ...
    SourceConfig(
        name="HigherEdJobs Agriculture",
        engine="generic_board",
        url="https://www.higheredjobs.com/faculty/search.cfm?JobCat=2",
        organization="HigherEdJobs",
        notes="Agriculture faculty positions on HigherEdJobs; captures agroforestry, forest products, and wood science roles.",
        pagination_param="PageNo",
    ),
    SourceConfig(
        name="HigherEdJobs Keyword: Forestry",
        engine="generic_board",
        url="https://www.higheredjobs.com/faculty/search.cfm?Keyword=forestry",
        organization="HigherEdJobs",
        notes="Keyword search across all HigherEdJobs faculty categories for 'forestry'; catches positions filed under non-forestry disciplines.",
        pagination_param="PageNo",
    ),
    SourceConfig(
        name="HigherEdJobs Keyword: Silviculture",
        engine="generic_board",
        url="https://www.higheredjobs.com/faculty/search.cfm?Keyword=silviculture",
        organization="HigherEdJobs",
        notes="Keyword search across all HigherEdJobs faculty categories for 'silviculture'.",
        pagination_param="PageNo",
    ),
    SourceConfig(
